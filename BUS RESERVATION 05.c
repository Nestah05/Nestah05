...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"SuperMetro","MetroTrans","ForwardTravellers","CityShuttle","Lothian"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
for(i=0; i<booking; i++)//for entering the person name and seat number in the file
{
    ...
    printf("\n======================================================================================================\n\n");
    printf("\n");
      itoa(number, tempstr, 10); //integer to ascii is itoa
...
void login()
{
    ...
    char user[10]="Nestah Khan";
    char pass[10]="makutesa";
    do
{
	system("cls");
	...
	i=0;
	//scanf("%s",&pword);
		if(strcmp(uname,"Nestah Khan")==0 && strcmp(pword,"makutesa")==0)
	{
